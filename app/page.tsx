    ...
    <main style={{fontFamily: "system-ui, sans-serif", minHeight: "100vh", backgroundColor: "#f8f4ef"}}>
      <header style={{background: "linear-gradient(135deg, #2d3a4a 0%, #1a2634 100%)", padding: "20px 48px", display: "flex", justifyContent: "space-between", alignItems: "center", position: "sticky", top: 0, zIndex: 100, borderBottom: "3px solid #c9a84c"}}>
        ...
        <nav style={{display: "flex", gap: "32px"}}>
          <Link href="#articulos" style={{fontSize: "13px", color: "#b8c4cc", textDecoration: "none", letterSpacing: "1px", textTransform: "uppercase", fontWeight: "500"}}>Articulos</Link>
      ...
      <section style={{background: "linear-gradient(160deg, #2d3a4a 0%, #3d5a6e 50%, #4a7c6f 100%)", padding: "120px 48px 100px", position: "relative", overflow: "hidden"}}>
        ...
        <div style={{maxWidth: "780px", margin: "0 auto", position: "relative"}}>
          ...
          <p style={{fontSize: "19px", color: "#a8bcc8", lineHeight: "1.8", maxWidth: "520px"}}>Escribo sobre economia, dinero y las verdades que nadie explica con claridad. Tambien construyo herramientas para simplificar lo complejo.</p>
        </div>
      </section>
      <section id="articulos" style={{maxWidth: "780px", margin: "0 auto", padding: "80px 48px"}}>
        <div style={{display: "flex", alignItems: "center", gap: "16px", marginBottom: "40px"}}>
          ...
          <h2 style={{fontSize: "28px", fontWeight: "800", letterSpacing: "-1px", color: "#2d3a4a", fontFamily: "Georgia, serif"}}>Articulos</h2>
        </div>
        {articulos && articulos.length > 0 ? (
          ...
          <div style={{background: "linear-gradient(135deg, #fff 0%, #f8f4ef 100%)", border: "1px solid #e8e0d5", borderRadius: "16px", padding: "40px", textAlign: "center"}}>
            <p style={{color: "#aaa", fontSize: "15px"}}>Proximamente.</p>
          </div>
        )}
      </section>
      <section id="libro" style={{background: "linear-gradient(135deg, #2d3a4a 0%, #3d5a6e 100%)", padding: "80px 48px"}}>
        <div style={{maxWidth: "780px", margin: "0 auto"}}>
          ...
          <div style={{background: "linear-gradient(135deg, rgba(255,255,255,0.08) 0%, rgba(255,255,255,0.04) 100%)", border: "1px solid rgba(201,168,76,0.3)", borderRadius: "20px", padding: "48px", display: "flex", gap: "48px", alignItems: "flex-start"}}>
            <div style={{width: "130px", height: "180px", background: "linear-gradient(160deg, #c9a84c 0%, #8b6914 100%)", borderRadius: "10px", flexShrink: 0, display: "flex", alignItems: "center", justifyContent: "center", boxShadow: "8px 8px 24px rgba(0,0,0,0.4)"}}>
            ...
            <div>
              <h3 style={{fontSize: "24px", fontWeight: "800", marginBottom: "8px", color: "#f0e6cc", fontFamily: "Georgia, serif"}}>Las verdades de una mentira</h3>
              <p style={{fontSize: "12px", color: "#c9a84c", fontWeight: "700", letterSpacing: "2px", textTransform: "uppercase", marginBottom: "20px"}}>El gobierno, la economia y tu dinero</p>
              <p style={{fontSize: "16px", color: "#a8bcc8", lineHeight: "1.8", marginBottom: "32px"}}>Una explicacion clara y directa de como funciona realmente el dinero fiduciario y por que tu capacidad adquisitiva se deteriora sin que nadie te lo explique.</p>
              <a href="https://amazon.com" target="_blank" rel="noopener noreferrer" style={{background: "linear-gradient(135deg, #c9a84c 0%, #e8c96e 100%)", color: "#1a1a1a", padding: "14px 32px", borderRadius: "10px", fontSize: "14px", fontWeight: "700", textDecoration: "none", display: "inline-block"}}>Ver en Amazon</a>
            </div>
          </div>
        </div>
      </section>
      <section id="herramientas" style={{maxWidth: "780px", margin: "0 auto", padding: "80px 48px"}}>
        ...
        <div style={{display: "grid", gridTemplateColumns: "1fr 1fr", gap: "20px"}}>
          <div style={{background: "linear-gradient(135deg, #2d3a4a 0%, #4a7c6f 100%)", borderRadius: "16px", padding: "32px", border: "1px solid rgba(74,124,111,0.3)"}}>
          ...
          <div style={{background: "linear-gradient(135deg, #f8f4ef 0%, #ede8e0 100%)", borderRadius: "16px", padding: "32px", border: "1px dashed #d4c9b8"}}>
            ...
            <p style={{fontSize: "14px", color: "#bbb", lineHeight: "1.6"}}>Proximamente.</p>
          </div>
        </div>
      </section>
      <section id="proyectos" style={{background: "linear-gradient(135deg, #4a7c6f 0%, #2d5a52 100%)", padding: "80px 48px"}}>
        <div style={{maxWidth: "780px", margin: "0 auto"}}>
          ...
          <div style={{background: "linear-gradient(135deg, rgba(255,255,255,0.1) 0%, rgba(255,255,255,0.05) 100%)", border: "1px solid rgba(201,168,76,0.2)", borderRadius: "16px", padding: "36px"}}>
            ...
            <p style={{fontSize: "16px", color: "#a8d4c8", lineHeight: "1.8", marginBottom: "8px"}}>Plataforma contable para pequenas empresas colombianas.</p>
