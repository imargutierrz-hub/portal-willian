    ...
    <main className="min-h-screen bg-white text-gray-900">
      <header className="border-b border-gray-100 px-6 py-4 flex justify-between items-center">
        ...
        <nav className="flex gap-6 text-sm text-gray-500">
          <Link href="#articulos" className="hover:text-gray-900">Articulos</Link>
          <Link href="#libro" className="hover:text-gray-900">Libro</Link>
          <Link href="#herramientas" className="hover:text-gray-900">Herramientas</Link>
          <Link href="#proyectos" className="hover:text-gray-900">Proyectos</Link>
        </nav>
      </header>
      <section className="max-w-3xl mx-auto px-6 py-24">
        <h1 className="text-5xl font-bold tracking-tight mb-6">Andres Gutierrez</h1>
        <p className="text-xl text-gray-500">Escribo sobre economia y las verdades que nadie explica con claridad.</p>
      </section>
      ...
      <section id="libro" className="max-w-3xl mx-auto px-6 py-16 border-t border-gray-100">
        ...
        <div className="border border-gray-100 rounded-xl p-8">
          ...
          <p className="text-gray-500 leading-relaxed mb-6">El gobierno, la economia y tu dinero.</p>
          <a href="https://amazon.com" target="_blank" rel="noopener noreferrer" className="inline-block bg-gray-900 text-white text-sm px-6 py-3 rounded-lg">Ver en Amazon</a>
        </div>
      </section>
      <section id="herramientas" className="max-w-3xl mx-auto px-6 py-16 border-t border-gray-100">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="border border-gray-100 rounded-xl p-6">
            ...
            <p className="text-gray-400 text-sm">Convierte IPs entre decimal, binario y hexadecimal.</p>
          </div>
      ...
      <section id="proyectos" className="max-w-3xl mx-auto px-6 py-16 border-t border-gray-100">
        ...
        <div className="border border-gray-100 rounded-xl p-8">
          ...
          <p className="text-gray-500">Plataforma contable para pequenas empresas colombianas.</p>
        </div>
      </section>
